...
<template>
  <li>
    ...
    <transition enter-active-class="transition ease-out duration-100" enter-from-class="transform opacity-0"
      ...
      <ul class="bg-[#102765] rounded-xl pt-3 pb-1 mb-4" v-if="isOpen">
          ...
          <li>
            <div :data-tooltip-show="type === 'md'" data-tooltip-pos="right" aria-label="Dashboard">
              <nuxt-link :to="sub.url"
                class="flex justify-center lg:justify-start duration-300 items-center gap-3 cursor-pointer px-5 py-3 mb-4 hover:bg-[#142e71] border-transparent"
