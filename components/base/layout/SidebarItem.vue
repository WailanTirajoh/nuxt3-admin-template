  ...
  <li v-else-if="item.submenu.length === 0">
    <div :data-tooltip-show="type === 'md'" data-tooltip-pos="right" :aria-label="item.name">
      <nuxt-link :to="item.url"
        ...
        :exact-active-class="level === 1 ? 'bg-[#1d152a] !md:hover:bg-[#1d152a] border-b-4 !border-[#150f1e] !text-[#f0f0f0] font-bold' : 'border-l-4 !border-gray-300 font-bold bg-[#1d152a] !text-[#f0f0f0]'"
