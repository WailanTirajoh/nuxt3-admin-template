...
<template>
  <div class="">
    ...
    <div v-else class="flex w-full items-center justify-center">
      <label
        class="transition-all duration-300 ease-in-out w-full flex flex-col items-center px-4 py-6 bg-white dark:bg-gray-800 dark:hover:bg-gray-900 dark:border-gray-700 dark:text-gray-300 text-gray-400 rounded-lg tracking-wide uppercase border cursor-pointer hover:bg-gray-800 hover:text-white">
